...
class VSourceImageImportBottom:
    View<VSourceImageImport, MSourceImageImport, CSourceImageImport>
{
    ...
    required init(controller:CSourceImageImport)
    {
        ...
        buttonCancel.setTitle(
            String.localizedView(key:"VSourceImageImportBottom_buttonCancel"),
        ...
        labelTitle.text = String.localizedView(
            key:"VSourceImageImportBottom_labelTitle")
        ...
        labelSubtitle.text = String.localizedView(
            key:"VSourceImageImportBottom_labelSubtitle")
